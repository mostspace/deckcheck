        ...
        <div class="flex min-h-full">
            ...
            <div class="bg-dark-800 w-full transform shadow-xl transition-transform duration-300 ease-in-out"
                ...
                <div class="flex-1 overflow-y-auto p-6">
                    <form id="vessel-form" action="{{ route('admin.vessels.update', $vessel) }}" method="POST"
                            ...
                            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <select name="type" required
                                        ...
                                        <option value="MY" {{ old('type', $vessel->type) == 'MY' ? 'selected' : '' }}>
                                            Motor Yacht (MY)</option>
                                        <option value="SY" {{ old('type', $vessel->type) == 'SY' ? 'selected' : '' }}>
                                            Sailing Yacht (SY)</option>
                                        <option value="MV" {{ old('type', $vessel->type) == 'MV' ? 'selected' : '' }}>
                                            Motor Vessel (MV)</option>
                                        <option value="SV" {{ old('type', $vessel->type) == 'SV' ? 'selected' : '' }}>
                                            Sailing Vessel (SV)</option>
                                        <option value="FV" {{ old('type', $vessel->type) == 'FV' ? 'selected' : '' }}>
                                            Fishing Vessel (FV)</option>
                                        <option value="RV" {{ old('type', $vessel->type) == 'RV' ? 'selected' : '' }}>
                                            Research Vessel (RV)</option>
                                    </select>
                                    @error('type')
                                        <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <input type="text" name="flag" value="{{ old('flag', $vessel->flag) }}"
                                ...
                                <div>
                                    ...
                                    <input type="text" name="registry_port"
                                        value="{{ old('registry_port', $vessel->registry_port) }}"
                                ...
                                <div>
                                    ...
                                    <input type="text" name="build_year"
                                        value="{{ old('build_year', $vessel->build_year) }}" placeholder="e.g., 2020"
                                        class="bg-dark-600 border-dark-500 w-full rounded-md border px-3 py-2 text-white placeholder-gray-400 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500">
                                    @error('build_year')
                                        <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <input type="text" name="vessel_make"
                                        value="{{ old('vessel_make', $vessel->vessel_make) }}"
                        ...
                        <div class="bg-dark-700 border-dark-600 rounded-lg border p-6">
                            ...
                            <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                                <div>
                                    ...
                                    <input type="number" name="vessel_size"
                                        value="{{ old('vessel_size', $vessel->vessel_size) }}" min="1"
                                        step="0.1"
                                        class="bg-dark-600 border-dark-500 w-full rounded-md border px-3 py-2 text-white placeholder-gray-400 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500">
                                    @error('vessel_size')
                                        <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="vessel_lwl"
                                        value="{{ old('vessel_lwl', $vessel->vessel_lwl) }}" min="1" step="0.1"
                                        class="bg-dark-600 border-dark-500 w-full rounded-md border px-3 py-2 text-white placeholder-gray-400 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500">
                                    @error('vessel_lwl')
                                        <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <input type="number" name="vessel_beam"
                                        value="{{ old('vessel_beam', $vessel->vessel_beam) }}" min="1"
                                        step="0.1"
                                        class="bg-dark-600 border-dark-500 w-full rounded-md border px-3 py-2 text-white placeholder-gray-400 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500">
                                    @error('vessel_beam')
                                        <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="vessel_draft"
                                        value="{{ old('vessel_draft', $vessel->vessel_draft) }}" min="0.1"
                                        step="0.1"
                                        class="bg-dark-600 border-dark-500 w-full rounded-md border px-3 py-2 text-white placeholder-gray-400 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500">
                                    @error('vessel_draft')
                                        <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="vessel_gt"
                                        value="{{ old('vessel_gt', $vessel->vessel_gt) }}" min="1"
                                        class="bg-dark-600 border-dark-500 w-full rounded-md border px-3 py-2 text-white placeholder-gray-400 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500">
                                    @error('vessel_gt')
                                        <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <input type="number" name="vessel_loa"
                                        value="{{ old('vessel_loa', $vessel->vessel_loa) }}" min="1"
                                        step="0.1"
                                        class="bg-dark-600 border-dark-500 w-full rounded-md border px-3 py-2 text-white placeholder-gray-400 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500">
                                    @error('vessel_loa')
                                        <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                            ...
                            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                                <div>
                                    ...
                                    <input type="text" name="official_number"
                                        value="{{ old('official_number', $vessel->official_number) }}"
                                        class="bg-dark-600 border-dark-500 w-full rounded-md border px-3 py-2 text-white placeholder-gray-400 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="mmsi_number"
                                        value="{{ old('mmsi_number', $vessel->mmsi_number) }}"
                                        class="bg-dark-600 border-dark-500 w-full rounded-md border px-3 py-2 text-white placeholder-gray-400 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500">
                                    @error('mmsi_number')
                                        <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <input type="text" name="callsign"
                                        value="{{ old('callsign', $vessel->callsign) }}"
                                        class="bg-dark-600 border-dark-500 w-full rounded-md border px-3 py-2 text-white placeholder-gray-400 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500">
                                    @error('callsign')
                                        <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                                    @enderror
                        ...
                        <div class="bg-dark-700 border-dark-600 rounded-lg border p-6">
                            ...
                            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                                <div>
                                    ...
                                    <input type="text" name="vessel_phone"
                                        value="{{ old('vessel_phone', $vessel->vessel_phone) }}"
                                        class="bg-dark-600 border-dark-500 w-full rounded-md border px-3 py-2 text-white placeholder-gray-400 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500">
                                    @error('vessel_phone')
                                        <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <input type="email" name="vessel_email"
                                        value="{{ old('vessel_email', $vessel->vessel_email) }}"
                                        class="bg-dark-600 border-dark-500 w-full rounded-md border px-3 py-2 text-white placeholder-gray-400 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500">
                                    @error('vessel_email')
                                        <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <input type="text" name="dpa_name"
                                        value="{{ old('dpa_name', $vessel->dpa_name) }}"
                                        class="bg-dark-600 border-dark-500 w-full rounded-md border px-3 py-2 text-white placeholder-gray-400 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500">
                                    @error('dpa_name')
                                        <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <input type="text" name="dpa_phone"
                                        value="{{ old('dpa_phone', $vessel->dpa_phone) }}"
                                        class="bg-dark-600 border-dark-500 w-full rounded-md border px-3 py-2 text-white placeholder-gray-400 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500">
                                    @error('dpa_phone')
                                        <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <input type="email" name="dpa_email"
                                        value="{{ old('dpa_email', $vessel->dpa_email) }}"
                                        class="bg-dark-600 border-dark-500 w-full rounded-md border px-3 py-2 text-white placeholder-gray-400 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500">
                                    @error('dpa_email')
                                        <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    <label class="mb-2 block text-sm font-medium text-gray-300">Account Owner</label>
                                    <select name="account_owner"
                                        class="bg-dark-600 border-dark-500 w-full rounded-md border px-3 py-2 text-white focus:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500">
                                        <option value="">Select Account Owner</option>
                                        @foreach ($users as $user)
                                            <option value="{{ $user->id }}"
                                                {{ old('account_owner', $vessel->account_owner) == $user->id ? 'selected' : '' }}>
                            ...
                            <div class="space-y-4">
                                @if ($vessel->hero_photo)
                                    <div class="bg-dark-600 rounded-lg p-4">
                                        <label class="mb-2 block text-sm font-medium text-gray-300">Current Hero
                                            Photo</label>
