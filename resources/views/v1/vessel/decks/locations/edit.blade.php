    ...
    <form action="{{ route('locations.update', $location) }}" method="POST" class="space-y-6">
        ...
        <div>
            ...
            <textarea name="description" id="description" rows="4"
                class="w-full resize-none rounded-lg border border-[#cfd4dc] bg-white px-3.5 py-2.5 text-base text-[#0f1728] placeholder-[#667084] focus:border-[#6840c6] focus:outline-none">{{ old('description', $location->description) }}</textarea>
        </div>
