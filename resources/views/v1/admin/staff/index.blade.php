...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-gray-400 mt-1">Manage system staff members and administrators</p>
        </div>
        ...
        <div class="bg-dark-800 rounded-lg p-6 border border-dark-600">
            <div class="flex items-center">
                <div class="p-2 bg-red-500/10 rounded-lg">
                    <i class="fa-solid fa-crown text-red-500 text-xl"></i>
                </div>
                <div class="ml-4">
        ...
        <form method="GET" action="{{ route('admin.staff.index') }}" class="space-y-4">
            ...
            <div class="flex items-center justify-between">
                ...
                @if(request()->hasAny(['search', 'role', 'status']))
                    <a href="{{ route('admin.staff.index') }}" class="text-gray-400 hover:text-white transition-colors duration-200">
        ...
        <div class="overflow-x-auto">
            <table class="w-full">
                <thead class="bg-dark-700 border-b border-dark-600">
                    <tr>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Staff Member</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">System Role</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Permissions Scope</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Vessel Access</th>
                        ...
                        <tr class="hover:bg-dark-700 transition-colors duration-150">
                            <td class="px-6 py-4">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <div class="text-sm font-medium text-white">{{ $member->full_name ?? 'Unknown Staff Member' }}</div>
                                ...
                                <div class="space-y-1">
                                    @if($member->system_role === 'superadmin')
                                        <div class="text-xs text-gray-300">
                                            <i class="fa-solid fa-shield-halved text-red-400 mr-1"></i>
                                            Full system access
                                        </div>
                                        <div class="text-xs text-gray-300">
                                            <i class="fa-solid fa-users text-red-400 mr-1"></i>
                                            User management
                                        </div>
                                        <div class="text-xs text-gray-300">
                                            <i class="fa-solid fa-database text-red-400 mr-1"></i>
                                            Data management
                                        </div>
                                    @elseif($member->system_role === 'staff')
                                        <div class="text-xs text-gray-300">
                                            <i class="fa-solid fa-ship text-purple-400 mr-1"></i>
                                            Vessel management
                                        </div>
                                        <div class="text-xs text-gray-300">
                                            <i class="fa-solid fa-tools text-purple-400 mr-1"></i>
                                            Maintenance tools
                                        </div>
                                        <div class="text-xs text-gray-300">
                                            <i class="fa-solid fa-chart-bar text-purple-400 mr-1"></i>
                                            Reports & analytics
                                        </div>
                                    @elseif($member->system_role === 'dev')
                                        <div class="text-xs text-gray-300">
                                            <i class="fa-solid fa-code text-green-400 mr-1"></i>
                                            System development
                                        </div>
                                        <div class="text-xs text-gray-300">
                                            <i class="fa-solid fa-bug text-green-400 mr-1"></i>
                                            Debug & testing
                                        </div>
                                        <div class="text-xs text-gray-300">
                                            <i class="fa-solid fa-server text-green-400 mr-1"></i>
                            ...
                            <td class="px-6 py-4">
                                <div class="space-y-1">
                                    ...
                                    @empty
                                        <span class="text-gray-500 text-sm">No vessel access</span>
                                    @endforelse
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center space-x-2">
                                    <a href="{{ route('admin.staff.show', $member) }}" class="text-accent-primary hover:text-blue-400 transition-colors duration-200" title="View Details">
                                        <i class="fa-solid fa-eye"></i>
                                    </a>
                                    <a href="{{ route('admin.staff.edit', $member) }}" class="text-accent-secondary hover:text-green-400 transition-colors duration-200" title="Edit Staff Member">
                                        <i class="fa-solid fa-edit"></i>
                                    </a>
                                    <button class="text-accent-warning hover:text-yellow-400 transition-colors duration-200" title="Manage Permissions">
                                        <i class="fa-solid fa-key"></i>
                                    </button>
                                    @if($member->system_role !== 'superadmin')
                                        <button class="text-accent-danger hover:text-red-400 transition-colors duration-200" title="Suspend Access">
