    ...
    <div class="flex min-h-full">
        ...
        <div class="w-full bg-dark-800 shadow-xl transform transition-transform duration-300 ease-in-out" id="modal-content">
            ...
            <div class="flex-1 overflow-y-auto p-6">
                <form id="vessel-form" action="{{ route('admin.vessels.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                    @csrf
                    ...
                    <div class="bg-dark-700 rounded-lg border border-dark-600 p-6">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-300 mb-2">Hero Photo</label>
