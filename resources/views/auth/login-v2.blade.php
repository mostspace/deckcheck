...
<body class="theme-light theme-transition h-full" style="background-color: var(--bg-primary);">
    <div class="flex min-h-full items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
        <div class="w-full max-w-md space-y-8">
            <!-- Theme Toggle -->
            <div class="flex justify-end">
                <button id="theme-toggle" class="rounded-lg border p-2"
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-6">
                    ...
                    <div>
                        <button type="submit" id="login-button"
                            class="flex w-full justify-center rounded-lg border border-transparent bg-primary-500 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-primary-600 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2">
                            Log in
                        </button>
                    </div>
                    ...
                    <div class="relative">
                        ...
                        <div class="relative flex justify-center text-sm">
                            <span
                                style="color: var(--text-muted); background-color: var(--bg-card); padding: 0 1rem;">Or</span>
                        </div>
                    </div>
