...
@section('content')
            ...
            <div class="p-6">
                <form method="POST" action="{{ route('invitations.accept.terms.store') }}" class="space-y-6">
                    ...
                    <div class="flex flex-col gap-2">
                        <label for="terms-scroll" class="text-[#344053] text-sm font-medium">Please review our Beta Program Terms & Conditions</label>
  ...
  <p><strong>Effective upon your acceptance.</strong> These Beta Terms &amp; Conditions (“<strong>Terms</strong>”) govern access to and use of the <strong>DeckCheck Beta</strong> pre-release service (“<strong>Beta Services</strong>”) offered by <strong>DeckCheck Technologies, LLC</strong>, a Connecticut limited liability company with a principal place of business at <strong>3 Elmcrest Terrace, Norwalk, CT 06850</strong> (“<strong>DeckCheck</strong>,” “<strong>we</strong>,” “<strong>us</strong>,” or “<strong>our</strong>”). By creating an account or using the Beta Services, you (“<strong>you</strong>” or “<strong>User</strong>”) agree to these Terms and our Privacy Policy at <a href="https://deckcheck.app/privacy" rel="noopener noreferrer">deckcheck.app/privacy</a>.</p>
    <br>
  <h2 id="section-1" class="text-xl font-bold">1. Nature of the Beta; Agreement Formation</h2><br>
...
<br>
  <h2 id="section-3" class="text-xl font-bold">3. Eligibility; Accounts; Authorized Users</h2><br>
...
<br>
  <h2 id="section-4" class="text-xl font-bold">4. Competitive Safeguards; Conflicts of Interest</h2><br>
...
<br>
  <h2 id="section-7" class="text-xl font-bold">7. Confidentiality &amp; Non-Disclosure (Key)</h2><br>
...
<br>
  <h2 id="section-10" class="text-xl font-bold">10. Data Loss/Leakage Risk; Release of Liability</h2><br>
...
<br>
  <h2 id="section-21" class="text-xl font-bold">21. Dispute Resolution; Arbitration (Connecticut)</h2><br>
...
<br>
  <h2 id="section-26" class="text-xl font-bold">26. Entire Agreement; Waiver; Severability</h2><br>
