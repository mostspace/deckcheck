    ...
    <div class="mb-6 flex items-center gap-4">
            ...
            <div class="flex-1 max-w-md">
                <div class="relative">
                    ...
                    <input type="text" placeholder="Search crew members..." class="w-full pl-10 pr-4 py-2.5 bg-white rounded-lg shadow-[0px_1px_2px_0px_rgba(16,24,40,0.05)] border border-[#cfd4dc] text-[#0f1728] placeholder-[#667084] focus:outline-none focus:ring-2 focus:ring-[#6840c6] focus:border-transparent">
                </div>
            </div>
            ...
            <div class="flex items-center gap-3">
                ...
                {{--Department Select--}}
                <div class="relative">
                    <select class="appearance-none pr-10 pl-3 px-4 py-2.5 bg-white rounded-lg shadow-[0px_1px_2px_0px_rgba(16,24,40,0.05)] border border-[#cfd4dc] text-[#344053] text-sm focus:outline-none focus:ring-2 focus:ring-[#6840c6] focus:border-transparent">
                ...
                {{--Create Button--}}
                <button class="px-4 py-2.5 bg-[#7e56d8] rounded-lg shadow-[0px_1px_2px_0px_rgba(16,24,40,0.05)] border border-[#7e56d8] text-white text-sm font-medium hover:bg-[#6840c6] transition-colors">
                ...
                <thead class="bg-[#f8f9fb] border-b border-[#e4e7ec]">
                    <tr>
                        <th class="px-6 py-3 text-left">
                            <button id="sort-name" type="button" class="flex items-center text-xs font-medium text-[#475466] hover:text-[#6840c6] uppercase tracking-wider">
                                Crew Member
                        ...
                        <tr class="hover:bg-[#f8f9fb] transition-colors">
                            <td class="px-6 py-4">
                                <div class="flex items-center">
                                    <img class="w-10 h-10 rounded-full" src="{{ Storage::url($user->profile_pic) }}" alt="Hero Photo for {{ $user->first_name }}">
                                    <div class="ml-4">
                                        <div class="text-sm font-medium text-[#0f1728] name" data-name="{{ strtolower($user->name) }}">{{ $user->name }}</div>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4">
                                <span class="px-2 py-0.5 bg-[#ebfdf2] rounded-2xl text-center text-[#027947] text-xs">{{ $user->department ?? 'N/A' }}</span>
                            </td>
