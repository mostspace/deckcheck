...
@section('content')
    ...
    @include('v2.components.navigation.page-header', [
        'tabs' => [
            ['id' => 'information', 'label' => 'Information', 'short' => 'Info', 'icon' => 'tab-overview.svg', 'active' => true],
            ['id' => 'crew', 'label' => 'Crew', 'short' => 'Crew', 'icon' => 'tab-crew.svg', 'active' => false],
            ['id' => 'deck-plan', 'label' => 'Deck Plan', 'short' => 'Plan', 'icon' => 'tab-specifications.svg', 'active' => false]
        ]
    ])
