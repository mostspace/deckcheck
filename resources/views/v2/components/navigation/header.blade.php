...
<header class="sticky top-0 z-20 flex flex-col">
    ...
    <div id="sub-header" class="px-3 sm:px-5 lg:px-8 py-3 border-b bg-white flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-2 flex-shrink-0">
        <!-- Breadcrumbs -->
