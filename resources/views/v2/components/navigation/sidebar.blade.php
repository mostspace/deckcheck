...
<!-- Sidebar (desktop) -->
<aside id="sidebar" aria-label="Main navigation" class="hidden md:flex bg-brand-900 text-slate-200 flex-col relative z-20 h-full gap-4 py-4">
    ...
    <div class="flex flex-col items-center space-y-4 sm:space-y-6 px-2.5">
