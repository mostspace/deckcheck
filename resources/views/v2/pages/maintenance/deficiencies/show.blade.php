...
@section('content')
    ...
    @include('v2.components.nav.header-routing', [
        ...
        'breadcrumbs' => [
            ...
            ['label' => 'Deficiencies', 'url' => route('deficiencies.index')],
            ['label' => 'DEF-0000' . $deficiency->id, 'active' => true]
        ],
        'actions' => [
            [
                'type' => 'link',
                'label' => 'Edit Deficiency',
                'url' => route('deficiencies.edit', $deficiency),
                'icon' => 'fas fa-edit',
                            ...
                            <div class="mb-4 flex items-center rounded-md border border-[#e4e7ec] bg-[#f9fafb] p-2 shadow-sm transition hover:bg-[#f3f4f6]"
                                ...
                                <div class="ml-4 flex min-w-0 flex-col">
                                    ...
                                    <div class="mb-1 flex items-center gap-1 text-xs text-[#667084]">
                                        ...
                                        <span
                                            class="font-medium text-[#344053]">{{ $deficiency->equipment->deck->name }}</span>
