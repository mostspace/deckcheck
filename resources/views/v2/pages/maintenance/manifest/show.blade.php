...
@section('content')
    ...
    @include('v2.components.nav.header-routing', [
        ...
        'refererContext' => ['equipment' => $equipment]
    ])
                    ...
                    <div class="flex gap-2">
                        ...
                        <div class="mr-1 flex h-8 w-8 items-center justify-center rounded-md border bg-[#f9f5ff]">
                            <a href="{{ route('maintenance.show', $equipment->category) }}">
                                <i
                                    class="fa-solid {{ $equipment->category->icon }} text-[#6840c6] hover:text-[#7e56d8]"></i>
                            </a>
                        </div>
                        ...
                        @foreach ($equipment->intervals as $interval)
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 text-sm font-medium">
                                    <button
                                        onclick="window.location='{{ route('maintenance.manifest.intervals.show', $interval) }}'"
            ...
            <header class="flex items-center justify-between border-b border-[#e4e7ec] px-6 py-4">
                <div class="flex items-center space-x-2">
                    ...
                    <div class="flex items-center space-x-1">
                        <div
                            class="flex h-8 w-8 items-center justify-center rounded-md border border-[#e4e7ec] bg-[#f9f5ff]">
            ...
            <div class="p-6">
                            ...
                            <div
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <button
                                        ...
                                        class="text-[#667084] transition-colors hover:text-red-500"
                ...
                @else
                    <div class="py-8 text-center text-[#667084]">
                        ...
                        <p class="text-sm">Upload manuals, certificates, and other important documents to keep them
