...
<div class="mb-6 flex items-center gap-4">
    <button onclick="window.location='{{ route('vessel.decks.create') }}'"
        class="rounded-lg border border-primary-500 bg-primary-500 px-4 py-2.5 text-sm font-medium text-slate-800 shadow-[0px_1px_2px_0px_rgba(16,24,40,0.05)] transition-colors hover:bg-primary-600">
