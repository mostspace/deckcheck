        ...
        <div id="panel-information" class="tab-panel" role="tabpanel" aria-labelledby="tab-information">
            ...
            <div class="mb-8">
                <div class="mb-6 flex items-center justify-between">
                    <div></div>
                    <button class="flex items-center gap-2 text-sm font-medium text-primary-600 hover:text-primary-700">
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <div>
                        ...
                        <input type="text" value="{{ $vessel->registry_port }}"
                            class="w-full rounded-lg border border-[#cfd4dc] bg-[#f8f9fb] px-3 py-2 text-[#0f1728]"
                            readonly="">
                    </div>
                    <div>
